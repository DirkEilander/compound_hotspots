...
# ufuncs for correlations
import bottleneck
import warnings
warnings.filterwarnings('ignore')

__all__ = ['bias', 'percentual_bias', 'nashsutcliffe', 'lognashsutcliffe', 
           'pearson_correlation', 'spearman_rank_correlation', 'rsquared', 'mse', 'rmse', 'kge',]
...
def bias(sim, obs, dim='time'):
    ...
    """
    # wrap numpy function
    kwargs = dict(input_core_dims=[[dim], [dim]], dask='parallelized', output_dtypes=[float])
